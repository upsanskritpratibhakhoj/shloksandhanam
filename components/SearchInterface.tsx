        ...
        <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-8 space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 border-l-4 border-saffron">
            ...
            <ul className="text-sm text-gray-600 space-y-2">
              <li>• बेहतर परिणाम के लिए रघुवंशम्, कुमारसंभवम्, मेघदूतम्, नैषधीयचरितम्, किरातार्जुनीयम्, श्रीमद्भगवद्गीता, सुदर्शनशतकम्, शिवमहिम्नस्तोत्र जैसे प्रसिद्ध ग्रंथों के श्लोक खोजें।</li>
          ...
          <div className="bg-white rounded-xl p-6 border-l-4 border-saffron">
            <h4 className="font-bold text-gray-800 mb-2 flex items-center gap-2">
              <span>💡</span>  श्लोकसंधानम् ऐप को अपने मोबाइल होम स्क्रीन पर पिन करें (Tips)
            </h4>
            <ul className="text-sm text-gray-600 space-y-2">
              <li>• दाहिने ऊपर तीन डॉट्स (⋮) पर क्लिक करें।</li>
              <li>• "Add to Home Screen" या "ऐप होम स्क्रीन पर जोड़ें"  चुनें।</li>
              <li>• बस! V आइकन वाला श्लोकसंधानम् ऐप होम स्क्रीन पर आ गया।</li>
            </ul>
          </div>
        </div>
      )}
